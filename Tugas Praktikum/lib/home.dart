...
class HomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 135, 119, 236),
      appBar: AppBar(
        leading: Builder(
...
class FreelancerList extends StatelessWidget {
  final List<Map<String, dynamic>> freelancers = [
    ...
    {
      "name": "Hijacket",
      "profession": "Islam Fashion",
      "rating": 4.9,
      "image": "images/pances.jpeg"
    },
    {
      "name": "U Halimah",
      "profession": "Ustadzah",
      "rating": 4.9,
      "image": "images/wajdi.png"
    },
    {
      "name": "Ustad felix",
      "profession": "Pengajar",
      "rating": 4.9,
      "image": "images/byadun.png"
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        const SizedBox(height: 10),
        ServiceCard(
          imageUrl: 'images/male1.jpeg',
          name: 'Ustad Adi Hidayat',
          role: 'Ulama',
          description: 'Pendakwah.',
          rating: 4.9,
        ),
        ServiceCard(
          imageUrl: 'images/girl2.jpeg',
          name: 'Sri Mulyan',
          role: 'Menkeu',
          description: 'Kementerian Keuangan.',
          rating: 4.9,
        ),
        ServiceCard(
    ...
    return Column(
      children: [
        BestBookingCard(
          ...
          profileUrl: 'images/wajdi.jpeg',
          name: 'Abyan Dzakwan Baksir',
          role: 'mahasiswa',
